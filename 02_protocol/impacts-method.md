...
Describe the work before changing it:

- Market topology: participants and the supply, demand or matching relationships between them.
- Value flow: value object, customer, payer and relevant external participant.
...
Assign each remaining part to its best execution form. Deterministic calculations stay in code or a Capability. The model handles variable language and context. People retain customer interaction, judgement and authority where the identified boundary requires them.
