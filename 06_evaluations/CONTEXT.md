...
This directory contains optional deterministic Core checks and a reading evaluation for cross-repository authority. Load only the branch needed by the question; synthetic fixtures establish no customer facts, authority or business effects.
...
- [Nontechnical reconstruction](nontechnical-reconstruction/CONTEXT.md): a frozen cold-reading case for one unclear spreadsheet, no established KPI or process, conflicting descriptions and one bounded useful result.
