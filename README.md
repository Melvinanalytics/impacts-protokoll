...
For new work, get the complete source archive from the [v0.3.5 release](https://github.com/Melvinanalytics/impacts-protokoll/releases/tag/v0.3.5), or clone that tag:

```bash
git clone --branch v0.3.5 --depth 1 https://github.com/Melvinanalytics/impacts-protokoll.git
